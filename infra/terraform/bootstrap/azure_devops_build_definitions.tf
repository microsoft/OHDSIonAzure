...
# Environment Pipeline - Terraform Apply
#############################
resource "azuredevops_build_definition" "tfapplyenvironmentpipeline" {
  ...
  repository {
    ...
    yml_path    = var.tf_apply_environment_pipeline_path
  }
...
#############################
# Import Azure DevOps Build Pipelines
# Environment Pipeline - Terraform Destroy
#############################
resource "azuredevops_build_definition" "tfdestroyenvironmentpipeline" {
  ...
  repository {
    ...
    repo_id     = azuredevops_git_repository.repo.id
    branch_name = azuredevops_git_repository.repo.default_branch
    yml_path    = var.tf_destroy_environment_pipeline_path
  }
